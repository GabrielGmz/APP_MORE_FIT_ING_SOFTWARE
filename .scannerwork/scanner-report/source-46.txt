<template>
  <div class="gestion-u">
    ...
    >
      ...
      <tbody>
      <tr 
      v-for="usuario in usuariosEntrenadores" 
      :key="usuario.uid"
      @click="abrirModalEntrenador(usuario)"
      >
      <td>{{ usuario.nombre }} {{ usuario.apellido }}</td>
      <td>{{ usuario.email }}</td>
      </tr>
    ...
    <div v-if="mostrarModalEntrenador" class="modal-overlay" @click.self="cerrarModalEntrenador">
      <div class="modal-content">
        ...
        <div class="modal-buttons">
          <button @click="pago(usuarioEntrenadorSeleccionado)">Pagar</button>
          <button @click="verPerfil(usuarioEntrenadorSeleccionado)">Ver perfil</button>
        </div>
        <button class="cerrar" @click="cerrarModalEntrenador">Cerrar</button>
      </div>
    </div>
