<template>
  <div class="container">
    ...
    <div class="perfil-usuario">
      ...
      <div v-else-if="perfilExiste">
        <div class="info-perfil">
          ...
          <p><strong>Email <br></strong> {{ perfil.email }}</p>
          ...
          <p><strong>Rol <br></strong> {{ perfil.rol }}</p>
        </div>
      </div>
    ...
    <div class="btn">
      <button class="btn_editar" @click="$router.push('/Gestion_U')">Regresar</button>
    </div>
  </div>
...
<style scoped>
/* Reutilizo los estilos que me diste */
.container {
