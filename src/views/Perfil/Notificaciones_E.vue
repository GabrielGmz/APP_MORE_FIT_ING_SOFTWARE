  ...
  <div class="container">
    ...
    <div class="cards">
      <div class="card">
        ...
        <select v-model="plantillaSeleccionada" @change="usarPlantilla">
        ...
        <form @submit.prevent="enviarNotificacion">
          ...
          <input type="text" v-model="titulo" placeholder="Título de la notificación" required />

          <label for="mensaje">Mensaje</label>
          <textarea v-model="mensaje" placeholder="Escribe el mensaje..." required></textarea>
